...
public class LegacyApplication implements Application, SystemListener {
    ...
    private static final Logger logger = Logger.getLogger(com.jme3.app.LegacyApplication.class.getName());
    ...
    private void initAssetManager() {
        ...
        if (settings != null) {
            ...
            if (assetCfg != null) {
                ...
                if (assetCfgUrl == null) {
                    assetCfgUrl = com.jme3.app.LegacyApplication.class.getClassLoader().getResource(assetCfg);
                    if (assetCfgUrl == null) {
...
//        timer.update();
    ...
    public void enqueue(Runnable runnable) {
        enqueue(new LegacyApplication.RunnableWrapper(runnable));
    }
